...
- [Game 4: Gone Fishin'](games/04-gone-fishin.md) — cast/reel, bezier line, fish AI, hold detection
- [Game 5: Outlaw Run](games/05-outlaw-run.md) — path drawing, scrolling world, sheriff waypoint nav
